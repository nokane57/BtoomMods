...
public class TimerBimItem extends Item {
    ...
    public void releaseUsing(ItemStack stack, World world, LivingEntity living, int timeLeft) {
        ...
        if (!world.isClientSide) player.getPersistentData().putInt("timer_cooldown", cooldown);
    ...
    public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entity) {
        ...
        // ✅ Ne jamais réinitialiser un timer déjà démarré
        ...
        // ⚙️ Ne jamais remettre à 10s si déjà en cours
    ...
    private boolean tickTimer(ItemStack stack, World world, Entity holder,
        ...
        // 🔁 Synchro toutes les secondes (pour HUD + bip)
